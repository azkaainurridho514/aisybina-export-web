  ...
  <div class="admin-shell">
    ...
    <div class="admin-content">
      ...
      <main class="admin-main">
        ...
        @include('pages.site-content.site-content')
        
        <!-- ===================== CATEGORIES ===================== -->
        @include('pages.catalog.category')
        
        <!-- ===================== PRODUCTS ===================== -->
        @include('pages.catalog.products')
        
        <!-- ===================== EXPORT PROCESS ===================== -->
        @include('pages.content-block.export-process')
        
        <!-- ===================== WHY CHOOSE US ===================== -->
        @include('pages.content-block.why-choose-us')
        
        <!-- ===================== ABOUT ITEMS ===================== -->
        @include('pages.content-block.about-item')
        
        <!-- ===================== BUSINESS HOURS ===================== -->
        @include('pages.content-block.business-hour')
        
        <!-- ===================== INQUIRIES ===================== -->
        @include('pages.lead.inquiry')
